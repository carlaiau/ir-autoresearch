...
/path/to/venv/bin/python reranking/run.py stage1/results/<branch>/<run-id> --top-k 100
```

The pass is a separate stage. The historical depth was 100; the current CLI
default is 200. The model argument defaults to jev-latest: on 2026-09-17 the API rejected the cookbook's jev-1.12 and listed
